...
function renderLadder() {
  ...
  root.innerHTML = order.map((tierKey, i) => {
    ...
    const descMap = {
      panel: "Sewa server sendiri, pakai untuk bot/aplikasimu.",
      reseller: "Jual ulang panel dengan harga & untung sendiri.",
      partner: "Benefit & akses paling luas di ekosistem Danzx.",
    };
    return `
      <a href="#${tierKey}" class="rung" style="--rung-color:${tier.color}">
...
function productSection(product) {
  ...
  return `
    <section id="${escapeHtml(product.key)}" class="product-section wrap">
