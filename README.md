# Danzx Cloud (v2 — desain baru + Nevapedia)

Website 1-page: Panel Pterodactyl • Reseller • Partner — checkout QRIS otomatis lewat **Nevapedia**, deploy sebagai Vercel Serverless Functions.

Ini versi **desain ulang total** (bukan re-skin) dari versi sebelumnya, dan datanya sudah disinkronkan dengan bot Telegram `CpanelDanzxbot` per 11-07-2026.
...
**Partner**:
Join Partner (sudah Reseller aktif) Rp30.000 · Join Partner Langsung (belum Reseller) Rp50.000 · Perpanjang Partner Rp10.000/30 hari
